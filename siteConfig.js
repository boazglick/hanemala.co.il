module.exports = {
  siteUrl: "https://hanemala.co.il", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "hanemala", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "hanemala", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "hanemala", // Used for App manifest e.g. Mobile Home Screen
  ...
  header: {
    navigation: [
      ...
      {
        label: "יצירת קשר",
        url: "https://hanemala.co.il/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://hanemala.co.il/sitemap.xml",
      },
